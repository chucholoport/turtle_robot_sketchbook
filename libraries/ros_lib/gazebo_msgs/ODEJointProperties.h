...
namespace gazebo_msgs
{
  ...
  class ODEJointProperties : public ros::Msg
  {
    ...
    ODEJointProperties():
      damping_length(0), st_damping(), damping(NULL),
      hiStop_length(0), st_hiStop(), hiStop(NULL),
      loStop_length(0), st_loStop(), loStop(NULL),
      erp_length(0), st_erp(), erp(NULL),
      cfm_length(0), st_cfm(), cfm(NULL),
      stop_erp_length(0), st_stop_erp(), stop_erp(NULL),
      stop_cfm_length(0), st_stop_cfm(), stop_cfm(NULL),
      fudge_factor_length(0), st_fudge_factor(), fudge_factor(NULL),
      fmax_length(0), st_fmax(), fmax(NULL),
      vel_length(0), st_vel(), vel(NULL)
    {
    }
