...
namespace gazebo_msgs
{
  ...
  class ContactState : public ros::Msg
  {
    ...
    ContactState():
      ...
      collision1_name(""),
      collision2_name(""),
      wrenches_length(0), st_wrenches(), wrenches(NULL),
      total_wrench(),
      contact_positions_length(0), st_contact_positions(), contact_positions(NULL),
      contact_normals_length(0), st_contact_normals(), contact_normals(NULL),
      depths_length(0), st_depths(), depths(NULL)
    {
    }
