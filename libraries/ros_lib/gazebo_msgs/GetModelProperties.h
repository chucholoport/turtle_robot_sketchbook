...
static const char GETMODELPROPERTIES[] = "gazebo_msgs/GetModelProperties";
  ...
  class GetModelPropertiesResponse : public ros::Msg
  {
    ...
    GetModelPropertiesResponse():
      parent_model_name(""),
      canonical_body_name(""),
      body_names_length(0), st_body_names(), body_names(NULL),
      geom_names_length(0), st_geom_names(), geom_names(NULL),
      joint_names_length(0), st_joint_names(), joint_names(NULL),
      child_model_names_length(0), st_child_model_names(), child_model_names(NULL),
      is_static(0),
      success(0),
      status_message("")
    {
