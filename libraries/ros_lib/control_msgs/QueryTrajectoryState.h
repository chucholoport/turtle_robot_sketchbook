...
static const char QUERYTRAJECTORYSTATE[] = "control_msgs/QueryTrajectoryState";
  ...
  class QueryTrajectoryStateResponse : public ros::Msg
  {
    ...
    QueryTrajectoryStateResponse():
      name_length(0), st_name(), name(NULL),
      position_length(0), st_position(), position(NULL),
      velocity_length(0), st_velocity(), velocity(NULL),
      acceleration_length(0), st_acceleration(), acceleration(NULL)
    {
    }
