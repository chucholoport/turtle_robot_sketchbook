...
namespace smach_msgs
{
  ...
  class SmachContainerStructure : public ros::Msg
  {
    ...
    SmachContainerStructure():
      header(),
      path(""),
      children_length(0), st_children(), children(NULL),
      internal_outcomes_length(0), st_internal_outcomes(), internal_outcomes(NULL),
      outcomes_from_length(0), st_outcomes_from(), outcomes_from(NULL),
      outcomes_to_length(0), st_outcomes_to(), outcomes_to(NULL),
      container_outcomes_length(0), st_container_outcomes(), container_outcomes(NULL)
    {
    }
