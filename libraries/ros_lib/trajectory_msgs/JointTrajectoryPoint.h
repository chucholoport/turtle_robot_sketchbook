...
namespace trajectory_msgs
{
  ...
  class JointTrajectoryPoint : public ros::Msg
  {
    ...
    JointTrajectoryPoint():
      positions_length(0), st_positions(), positions(NULL),
      velocities_length(0), st_velocities(), velocities(NULL),
      accelerations_length(0), st_accelerations(), accelerations(NULL),
      effort_length(0), st_effort(), effort(NULL),
      time_from_start()
    {
    }
